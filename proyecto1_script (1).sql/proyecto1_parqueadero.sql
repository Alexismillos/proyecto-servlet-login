...
CREATE TABLE `parqueadero` (
  ...
  KEY `FK_Parqueadero_Administrador` (`Administrador_id`),
  CONSTRAINT `FK_Parqueadero_Administrador` FOREIGN KEY (`Administrador_id`) REFERENCES `administrador` (`idAdministrador`)
...
-- Dump completed on 2026-09-23 20:31:19
